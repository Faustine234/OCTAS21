...
// ========================
// Update stok gold guild jika form disubmit
// ========================
if (isset($_POST['update_stock'])) {
    $newStock = (int)$_POST['total_gold'];

    // Update database
    $update = mysqli_query($conn, "UPDATE gold_stock SET total_gold = '$newStock' WHERE id = 1");

    if ($update) {
        echo "<script>alert('✅ Stok Gold berhasil diperbarui!'); window.location='index.php';</script>";
    } else {
        echo "<script>alert('❌ Gagal memperbarui stok gold.');</script>";
    }
}
...
<body>
    ...
    <section class="hero d-flex align-items-center justify-content-center text-center text-light">
        <div data-aos="zoom-in">
            ...
            <!-- Form Update Stok -->
            <form method="post" class="d-inline-flex mt-3 justify-content-center">
                <input type="number" name="total_gold" class="form-control me-2 text-center" 
                       style="width: 200px;" value="<?php echo $stockGold; ?>" required>
                <button type="submit" name="update_stock" class="btn btn-success">🔄 Update Stok</button>
            </form>

            <!-- Terdistribusi -->
            <h5 class="mt-4">📊 Total Gold Terdistribusi: 
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="laporan_officer.php" class="btn btn-outline-warning btn-sm">Lihat Laporan</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="laporan_cross.php" class="btn btn-outline-warning btn-sm">Lihat Laporan</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="laporan_jotun.php" class="btn btn-outline-warning btn-sm">Lihat Laporan</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-dark text-light text-center py-3">
        <p>&copy; <?php echo date("Y"); ?> Gold Guild Management | BY OCTA</p>
    </footer>
